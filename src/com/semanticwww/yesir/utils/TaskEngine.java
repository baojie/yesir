...
public class TaskEngine
{
    ...
    private static long newWorkerTimestamp = CacheFactory.currentTime ;
    private static long busyTimestamp = CacheFactory.currentTime ;
    ...
    static
    {
        ...
        // Use 10 worker threads by default.
    ...
    private static Runnable nextTask()
    {
        synchronized( lock )
        {
            ...
            if( busy )
            {
                ...
                busyTimestamp = CacheFactory.currentTime ;
    ...
    private static void addWorker()
    {
        ...
        if( workers.length < 30 &&
            CacheFactory.currentTime > newWorkerTimestamp + 2000 )
        {
            ...
            workers = newWorkers ;
            newWorkerTimestamp = CacheFactory.currentTime ;
        }
    }
    ...
    private static void removeWorker()
    {
        ...
        if( workers.length > 3 &&
            CacheFactory.currentTime > busyTimestamp + 1000 * 5 )
        {
